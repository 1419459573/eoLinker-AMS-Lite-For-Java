...
public interface ApiGroupMapper
{
	...
	//获取子分组列表
	public List<Map<String,Object>> getChildGroupList(@Param("projectID")Integer projectID, @Param("parentGroupID")Integer parentGroupID);
	...
	//三级分组获取一级父分组ID
	public Integer getTopParentGroupID(@Param("groupID")Integer groupID);
}
